...
<AccordionGroup>
  ...
  <Accordion title="Memory Clipboard (v2.20.0)">
    ...
    - MCP tools: pluggedin_clipboard_set, pluggedin_clipboard_get, pluggedin_clipboard_push, pluggedin_clipboard_pop, pluggedin_clipboard_delete, pluggedin_clipboard_list
  </Accordion>

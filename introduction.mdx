...
<CardGroup cols={3}>
  ...
  <Card title="Discussions" icon="comments" href="https://github.com/VeriTeknik/pluggedin-app/discussions">
    Join the community discussion
  </Card>
  <Card title="Email Support" icon="envelope" href="mailto:support@plugged.in">

...
<CardGroup cols={3}>
  <Card title="v3.1.0" icon="brain">
    **Current Stable**
    Collective Best Practices & Intelligent Memory
  </Card>
  <Card title="v3.0.0" icon="rocket">
    Agent Architecture & Vector Search
    Major Platform Release
  </Card>
  <Card title="v2.12.0" icon="shield-halved">
...
|---------|--------|--------------|
| 3.1.x | **Current** | Active development |
| 3.0.x | Supported | September 2026 |
| 2.12.x | Maintenance | June 2026 |
| 2.10.x - 2.11.x | Maintenance | March 2026 |
| < 2.10.0 | End of Life | - |

## Migration Guides

- [Migrating to v3.1.0](/releases/v3-1-0#migration-notes)
- [Migrating to v3.0.0](/releases/v3-0-0#migration-notes)

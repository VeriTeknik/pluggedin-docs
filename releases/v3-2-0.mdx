...
1. **Cluster Discovery** (no LLM): Uses zvec embeddings and Union-Find to identify connected components of memories with cosine similarity >= 0.75
...
| **Self-Awareness** | Memory search usage + decay acceptance + dream consolidation count | 25 |

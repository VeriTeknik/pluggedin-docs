...
## Quick Start (Hosted Platform)

The fastest way to get started is using our hosted platform at [plugged.in](https://plugged.in).
...
- [Community Discord](https://discord.gg/pluggedin)

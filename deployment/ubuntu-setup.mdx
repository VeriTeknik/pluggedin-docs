...
# Security
MCP_ISOLATION_TYPE="none"  # Or "firejail" if installed
...
### 2. Install Sandboxing (Optional)

<Note>
Sandboxing provides additional security for running MCP servers but may impact performance.
</Note>
...
# Update .env
echo 'MCP_ISOLATION_TYPE="firejail"' >> .env
```
